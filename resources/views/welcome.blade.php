                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <button type="button" class="btn btn-secondary" data-toggle="modal"
                                        data-target="#modal-devolucion-libros{{ $prestamo->id }}">
                                        Devolver
                                    </button>
                                </td>

                                <!-- Devolución de Libros Modal START -->
                                <div class="modal fade" id="modal-devolucion-libros{{ $prestamo->id }}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form
                                                action="{{ route('renta-libros.destroy', ['renta_libro' => $prestamo->id]) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <div class="modal-body">
                                                    <p class="text-center" style="font-size: 18px;">¿Estás seguro de
                                                        ...
                                                        alquilado por:<br>
                                                        <b> <i> {{ $prestamo->user->nombre }} {{ $prestamo->user->app }}
                                                                {{ $prestamo->user->apm }}</i>
                                                        </b>
                                                    </p>
                                                </div>
                                                <div class="modal-footer justify-content-center">
                                                    <button type="button" style="margin-right: 2%"
                                                        class="btn btn-secondary" data-dismiss="modal"
                                                        style="font-size: 16px;">Cancelar</button>
                                                    <button type="submit" class="btn btn-primary"
                                                        style="font-size: 16px;">Confirmar</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
